 ...
 */
final class Version20260410123102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `role` (id INT AUTO_INCREMENT NOT NULL, role_name VARCHAR(50) NOT NULL, permissions LONGTEXT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
