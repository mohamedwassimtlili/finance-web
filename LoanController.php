...
class LoanController extends AbstractController
{
    ...
    public function dashboard(LoanRepository $loanRepo, HttpClientInterface $client): Response
    {
        ...
        return $this->render('loan/dashboard.html.twig', [
            ...
            'economicNews' => $economicNews,  // Economic news from API
            'eurRate' => $eurRate,
            'usdRate' => $usdRate,
        ]);
    }
    ...
    public function simulate(Request $request): JsonResponse
    {
        ...
        $monthsToPay = ($monthly > 0) ? ceil($remaining / $monthly) : 0;
        
        return new JsonResponse([
            'months' => $monthsToPay,
            'message' => "At this rate, you will be debt-free in " . $monthsToPay . " months."
        ]);
    }

    /**
     * 6. ADVANCED REPAYMENT (Form Handling)
     */
    ...
    public function addRepayment(Loan $loan, Request $request, EntityManagerInterface $em): Response
    {
        ...
        $form = $this->createForm(RepaymentType::class, $repayment);
        ...
        return $this->render('repayment/new.html.twig', [
            'loan' => $loan, 
