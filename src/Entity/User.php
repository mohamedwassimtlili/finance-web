...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'borrower', targetEntity: Loan::class)]  // ← FIXED
    ...
    public function setRoleId(int $roleId): static { $this->roleId = $roleId; return $this; }

    public function getPassword(): string { return $this->passwordHash; }
    public function setPassword(string $passwordHash): static { $this->passwordHash = $passwordHash; return $this; }
    ...
    public function getGoogleAccount(): ?bool { return $this->googleAccount; }
    public function setGoogleAccount(?bool $googleAccount): static { $this->googleAccount = $googleAccount; return $this; }
